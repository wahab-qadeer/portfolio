...
<head>
    ...
    <style>
        ...
        /* =========================================
           GLASSMORPHISM UI PANELS (Perfectly structured)
           ========================================= */
        .glass-card {
        ...
        /* =========================================
           HERO IMAGE SHOWCASE (Clean, Left-Aligned)
           ========================================= */
        .image-showcase {
            position: relative;
            width: 100%;
        ...
        /* =========================================
           CHART CONTAINERS (Strictly constrained)
           ========================================= */
        .chart-container {
            position: relative;
            width: 100%;
...
<body class="selection:bg-neon-emerald selection:text-system-950">
    ...
    <header class="fixed top-0 left-0 w-full z-50 px-4 sm:px-8 py-5 transition-all duration-300" id="header">
        <div class="max-w-[1400px] mx-auto">
            <div class="glass-card rounded-2xl px-6 md:px-10 py-4 flex items-center justify-between">
                ...
                <!-- Desktop Nav -->
                <nav class="hidden lg:flex items-center space-x-10 text-sm font-semibold text-slate-300">
    ...
    <main class="relative pt-36 pb-20">
        ...
        <!-- =========================================
             HERO SECTION (Fixed text wrapping & arrangement)
             ========================================= -->
        <section id="about" class="min-h-[85vh] flex items-center justify-center px-6 lg:px-8 py-12">
            <div class="max-w-[1400px] mx-auto w-full">
                
                <!-- Strict flex layout to keep image and text cleanly separated -->
                <div class="flex flex-col lg:flex-row items-center justify-between gap-16 lg:gap-24">
                    ...
                    <!-- RIGHT COLUMN: Typography & Action (Fixed Line Breaks) -->
                    <div class="w-full lg:w-7/12 flex flex-col items-center lg:items-start text-center lg:text-left order-1 lg:order-2 reveal-up" style="transition-delay: 150ms;">
                        ...
                        <!-- FIX: Typing Text Row. Used flex-row and whitespace-nowrap to prevent the text from breaking to the next line. -->
                        ...
                        <!-- FIX: Aligning Buttons and KPIs horizontally using robust flex constraints -->
        ...
        <!-- =========================================
             ANALYTICS DASHBOARD (Bento Box Layout)
             ========================================= -->
        ...
        <!-- =========================================
             PROJECTS SECTION (Extensive breathing room)
             ========================================= -->
        ...
        <!-- =========================================
             CONTACT / TERMINAL SECTION (FIXED LAYOUT)
             ========================================= -->
            ...
            <div class="max-w-[1200px] mx-auto">
                ...
                <div class="glass-solid rounded-[3rem] p-8 sm:p-12 lg:p-16 border border-neon-emerald/30 shadow-[0_30px_70px_rgba(0,0,0,0.8),0_0_50px_rgba(16,185,129,0.1)] reveal-up">
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24">
                        ...
                        <!-- LEFT SIDE: Text and Social Links (Fixed spacing & icons) -->
                        <div class="flex flex-col justify-center">
                            ...
                            <!-- FIX: Social Links Box styling. Used shrink-0 on icons and flex-col for text to ensure perfect alignment without squashing. -->
                            <div class="space-y-6">
                        ...
                        <!-- RIGHT SIDE: Terminal Form (Fixed layout, clean button) -->
                        <div class="bg-[#010403] rounded-[2.5rem] p-8 sm:p-12 border border-system-700 shadow-inner w-full flex flex-col justify-center">
                            ...
                            <form id="contact-form" class="space-y-8">
                                ...
                                <!-- FIX: Submit Button strictly structured to fill width and center contents -->
    ...
    <!-- Modals 2, 3, 4 (Simplified HTML structure for brevity but using same robust CSS classes) -->
    ...
    <script>
        ...
        // 2. Typing Effect (Matching user context explicitly)
        ...
        document.addEventListener("DOMContentLoaded", function() {
            ...
            // Chart 4: Mixed Line & Bar (Learning Velocity)
